package org.yoki_manager.orientdb;
...
import org.yoki_manager.orientdb.controls.odocument.OClassVBox;
import org.yoki_manager.orientdb.controls.odocument.OVertexVBox;
...
import org.yoki_manager.orientdb.controls.oproperty.OPropertyTextArea;
import org.yoki_manager.orientdb.controls.titledpanes.ScrollableTitledEntityPane;
...
import org.yoki_manager.orientdb.treetableview.OVertexNode;
...
public class OrientdbJavafx {
    ...
    public void addOVertex(TreeTableView<OVertexNode> oVerticesTree, TableView<OPropertyNode> oPropertiesTable,
        ...
        try {
            ...
            /*if (_is_Tree_DB)*/
            ti = oVerticesTree.getSelectionModel().getSelectedItem();
        ...
        dialog.setResultConverter(new Callback<ButtonType, New_OVertex>() {
            ...
            public New_OVertex call(ButtonType b) {
                if (b == buttonTypeOk) {
                    ...
                    TreeItem<OClassNode> ti = OClass_treetableview.getSelectionModel().getSelectedItem();
                    if (ti == null) {
    ...
    private final String[] Forbidden_Record_Names = new String[]{OrientdbTalker.Root_Vertex_Name};
                    ...
                    try (ODatabaseSession db = orientdb.openDB()) {
                        ...
                        for (javafx.scene.Node node : oVertexVBoxChildren) {
                            if (node instanceof TextField && node.getId() == oVertexVBoxNameTextField) {
                                ...
                                OrientdbTalker.setOVertexName(oVertex, newName);
                            }
    ...
    public void readOPropertiesDataFromOVertex(TreeTableView oVerticesTree, TitledEntitiesPanes titledPanes, boolean inNewTitledPane) {
        try {
            ...
            if (ti != null) {
                ...
                String oVertexName = OrientdbTalker.getOVertexName(oVertex);
